// doc here : http://open.weibo.com/wiki/2/search/statuses/en

require('../../config.apikeys.json')
...
(function(root) {
    ...
    hyve.feeds.twitter = {
        ...
        oauth_version : '1.0',
        feed_urls : {
            search: 'http://api.weibo.com/search.json?q={{query}}&lang=en&include_entities=True{{#&result_type=#result_type}}{{since}}{{#&callback=#callback}}',
